          ...
          <div class="card-header row gutters-5">
            <div class="col text-center text-md-left">
              ...
              <div class="col-md-3 ml-auto">
                  <select class="form-control form-control-lg" data-placeholder="{{ translate('Filter by Payment Status')}}" name="payment_status" onchange="sort_orders()">
              ...
              <div class="col-md-3 ml-auto">
                <select class="form-control form-control-lg" data-placeholder="{{ translate('Filter by Payment Status')}}" name="delivery_status" onchange="sort_orders()">
              ...
              <div class="col-md-3">
                <div class="from-group mb-0">
                    <input type="text" class="form-control form-control-lg" id="search" name="search" @isset($sort_search) value="{{ $sort_search }}" @endisset placeholder="{{ translate('Type Order code & hit Enter') }}">
                </div>
              </div>
          </div>
        </form>
