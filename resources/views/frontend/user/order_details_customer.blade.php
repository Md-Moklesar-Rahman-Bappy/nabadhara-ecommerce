    ...
    <div class="py-4">
        <div class="row gutters-5 text-center aiz-steps">
            <div class="col @if($status == 'pending') active @else done @endif">
                ...
                <div class="title fa-12">{{ translate('Order placed')}}</div>
            </div>
