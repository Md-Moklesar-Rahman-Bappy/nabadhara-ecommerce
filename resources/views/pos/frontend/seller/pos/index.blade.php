                        ...
                        <div class="card-body">
                            ...
                            <div class="row gutters-5">
                                <div class="col-6">
                                    <div class="">
                                        <div class="form-group">
                                            <select name="poscategory" class="form-control form-control-sm" data-live-search="true" onchange="filterProducts()">
                                ...
                                <div class="col-6">
                                    <div class="">
                                        <div class="form-group">
                                            <select name="brand" class="form-control form-control-sm" data-live-search="true" onchange="filterProducts()">
                        ...
                        <div class="card-body">
                            <div class="d-flex">
                                <div class="flex-grow-1">
                                    <select name="user_id" class="form-control form-control-sm pos-customer" data-live-search="true" onchange="getShippingAddress()">
                    ...
                    <div class="card mb-3" id="cart-details">
                        <div class="card-body">
                            <div class="aiz-pos-cart-list c-scrollbar">
                                <table class="table table-borderless mb-0" cellspacing="0" width="100%">
                                    <thead>
                                        <tr>
