...
Route::group(['middleware' => ['user', 'verified', 'unbanned']], function() {
    ...
    Route::get('/topup/select-operator/{operator_name}', 'TopUpController@addOperator')->name('topup.selectOperator');

    Route::get('/topup/step-1', 'TopUpController@enterMobileNumber')->name('topup.enterNumber');
    Route::post('/topup/step-1/post', 'TopUpController@postMobileNumber')->name('topup.submitNumber');

    Route::get('/topup/step-2', 'TopUpController@enterStep2')->name('topup.step2');
    Route::post('/topup/step-2/post', 'TopUpController@postStep2')->name('topup.submitstep2');

    Route::get('/topup/step-3', 'TopUpController@enterStep3')->name('topup.step3');
    Route::post('/topup/step-3/post', 'TopUpController@postStep3')->name('topup.submitstep3');
    
    Route::get('/topup/step-4', 'TopUpController@enterStep4')->name('topup.step4');
    Route::post('/topup/step-4/post', 'TopUpController@postStep4')->name('topup.submitstep4');
    ...
    Route::get('/address', 'HomeController@useraddress')->name('user_address.index');
    Route::post('/address/update', 'HomeController@update_address')->name('user.save_address');
});
